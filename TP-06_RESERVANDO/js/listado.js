...
Listado.prototype.buscarRestaurante = function(id) {
    let restaurantEncontrado = this.restaurantes.find(restaurant => restaurant.id === id);
...
Listado.prototype.obtenerCiudades = function() {
    ...
    return this.eliminarElemRepetidos(ciudades).sort();
}
...
Listado.prototype.obtenerRubros = function() {
    ...
    return this.eliminarElemRepetidos(rubros).sort();
}
...
Listado.prototype.obtenerHorarios = function() {
    ...
    let arrayHorarios = this.restaurantes.map(restaurant => restaurant.horarios);
    //En este arreglo vamos a poner todos los horarios pero sin repetidos
    return this.eliminarElemRepetidos(arrayHorarios).sort();
}


Listado.prototype.eliminarElemRepetidos = function(arrayElementos) {
